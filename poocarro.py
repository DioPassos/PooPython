...
class Moto(Carro):
    ...
    def ligar(self):
        return f"A moto {self.marca} está agora ligada."

    def desligar(self):
        return f"A moto {self.cor} do ano {self.ano} está agora desligada."

    def acelerar(self):
        return f"A moto {self.marca} está acelerando com potência de {self.potencia}."
